...
> <p style='text-align: justify;'> Although there are now several papers in the literature documenting the impact of the COVID-19 pandemic on domestic violence, this study adresses two key and previously unexplored questions about the effect of the quarantine policies on domestic violence reporting: 1) the role of third party vs victims' reporting of intimate partner violence (IPV) through hotline calls; 2) the extent to which reported domestic violence translated into protection given to victims. To address the first question, we focus on the effect of the introduction of the first lockdown in Spain on the number of reported cases of domestic violence by victims and third parties. In order to do so, we exploit province-level and monthly data on the number of calls to the dedicated emergency hotline for IPV victims between 2013 and 2020. We find that the introduction of the first lockdown was responsible for an average increase in total calls of 48%, which represents an additional 26,000 calls compared to previous years. Importantly, we also show that help-seeking behavior is at the origin of 70% of all reported calls. With respect to the second question, we provide evidence of a relative decrease of reporting to the police compared to the increase in violence that we document, which led a drop in the level of protection of victims. Despite the large increase in reported gender violence during the pandemic, we estimate that the introduction of lockdown caused a loss of at least 1,500 protection orders to victims that would, in the absence of the pandemic, have received it.</p>
